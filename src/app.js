          	...
          	<div class="card text-white mb-3 h-100">
            	...
            	<div class="card-body d-flex align-items-center justify-content-center">
					<div class="donate btn p-0">
						<a class="btn" href="https://trakteer.id/erlkim/tip" title="Click me!" style="background: #BE1E2D;" target="_blank">
...
<script type='text/javascript' class='troverlay'>(function() {var trbtnId = trbtnOverlay.init('Donasi','#be1e2d','https://trakteer.id/erlkim/tip/embed/modal','https://cdn.trakteer.id/images/mix/cendol.png','40','floating-left');trbtnOverlay.draw(trbtnId);})();</script>
...
function list(path, id = '', fallback = false) {
  ...
  <div id="readme_md" style="display:none; padding: 20px 20px;"></div>
	...
	function handleSuccessResult(res, path, prevReqParams) {
		...
		$('#sharer').attr('href', 'https://index.erlkim.workers.dev/f/' + res['fid']);
	...
	try {
		...
		for (i in files) {
			...
			if (item['mimeType'] == 'application/vnd.google-apps.folder') {
				...
				${UI.display_drive_link ? `<a class="d-flex align-items-center" href="https://index.erlkim.workers.dev/f/${item['fid']}" target="_blank" title="via Google Drive">${gdrive_icon}</a>` : ``}
...
function onSearchResultItemClick(file_id, can_preview, file) {
	...
	var gdrive_btn = `<a class="btn btn-secondary d-flex align-items-center gap-2" href="https://index.erlkim.workers.dev/f/${file['fid']}" id="file_drive_link" target="_blank">${gdrive_icon}Google Drive</a>`;
		...
		<div class="card-body row g-3">
			...
			<div class="col-md-12">
				<div class="text-center">
					...
					<div class="btn-group text-center"> ${UI.display_drive_link ? ` <a class="btn btn-secondary d-flex align-items-center gap-2" href="https://index.erlkim.workers.dev/f/${file_id}" id="file_drive_link" target="_blank">`+gdrive_icon+`Google Drive</a>` : ``} <a href="${url}" type="button" class="btn btn-success">
